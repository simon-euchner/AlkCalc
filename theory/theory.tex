...
\begin{document}
    ...
    with effective charge $Z_\mathrm{eff}=1$ for alkali-metal atoms and
    $Z_\mathrm{eff}=2$ for singly ionised alkaline-earth metal atoms. This is
    ...
    the effective Coulomb potential with charge $Z_\mathrm{eff}$ at long
    distances. Following

...
\begin{document}
    ...
    \end{equation}%
    %
    To numerically compute the remaining integrals we use a two-point Gau\ss ian
    quadrature. This method approximates the integral as \cite{burden2011}:
    \begin{equation}
    ...
    easily possible, such that, typically, all practical cases are included.
    Finally, we remark that one can improve on the precision by employing
    higher-order Gau\ss ian quadrature algorithms as described in
    \cite{burden2011}.

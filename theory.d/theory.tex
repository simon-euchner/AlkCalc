...
\begin{document}
    ...
    \begin{sdocfun}
    {
        ...
        \sdocarg{double j}{
            Total angular momentum quantum number
            $j=\abs*{l-1\slash{2}},l+1\slash{2}$. Here, the same convention as
            for the half-integer inputs in \texttt{alkcalc\tus{cj1m1j2m2j3m3}}
            applies.
        }
        \sdocarg{double mj}{
    ...
    \begin{sdocfun}
    {
        ...
        \sdocarg{double ji}{
            ...
            $\bm{\Psi}_\mathrm{i}$, $j$. Total angular momentum quantum number
            $j=\abs*{l-1\slash{2}},l+1\slash{2}$. Here, the same convention as
            for the half-integer inputs in \texttt{alkcalc\tus{cj1m1j2m2j3m3}}
            applies.
        }
        ...
        \sdocarg{double jf}{
            ...
            $\bm{\Psi}_\mathrm{f}$, $j$. Here, the convention for \texttt{ji}
            (see above) is adopted.
        }

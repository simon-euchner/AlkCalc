...
\begin{document}
    ...
    \ind We emphasise here that for $k=1$ and $p$ negative enough, the above
    ...
    \ind The off-diagonal matrix elements of $R_p$ read
    \begin{equation}
        B(\phi_k,\mathrm{id}^p\phi_{k+1})
        =
        \begin{cases}
    ...
    \end{equation}%
    %
    With this result it is straight-forward to construct the matrix $R_p$, that
    is, it is straight-forward to compute arbitrary radial matrix elements.

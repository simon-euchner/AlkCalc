...
\begin{document}
    ...
    any $q\in[-0.25,0.25)$ we use $q=-1\slash{2}$, for $q\in[0.25,0.75)$ we use
    $q=1\slash{2}$, and so on, in both the negative and positive direction. In
    the following manual, this convention is applied to all quantum numbers that
    can take half-integer values, unless states otherwise.

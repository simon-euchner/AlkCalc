...
\begin{document}
    ...
    \begin{sdocfun}
    {
        ...
        Radial matrix elements with arbitrary power $p\in\mathbb{R}$ [see
    ...
    \begin{sdocfun}
    {
        ...
        \sdocarg{double m1}{
            Projection quantum number of first factor.
        }
        \sdocarg{double j2}{
            Angular momentum quantum number of second factor.
        }
        \sdocarg{double m2}{
            Projection quantum number of second factor.
        }
        \sdocarg{double j}{
            Total angular momentum quantum number.
        }
        \sdocarg{double mj}{
            Projection quantum number of total angular momentum.
        }
    ...
    \begin{sdocfun}
    {
        ...
        \sdocarg{int32\tus{t} ml}{
            Projection quantum number of orbital angular momentum.
        }
        \sdocarg{double s}{
            Electron spin quantum number. Not an argument here, since
            $s=1\slash{2}$ is always assumed.
        ...
        \sdocarg{double ms}{
            Projection quantum number of electron spin, $m_s$. For any $m_s<0$
    ...
    \begin{sdocfun}
    {
        ...
        \sdocarg{double mj}{
            Projection quantum number of total angular momentum, $m_j$.
            Regarding the floating point representation of half-integers, the
            same convention as for the total angular momentum quantum number $j$

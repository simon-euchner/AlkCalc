...
\begin{document}
    ...
    \begin{sdocfun}
    {
        ...
        \sdocarg{int32\tus{t} l}{
            Orbital angular momentum quantum number $l=0,2,\dots,n-1$.
        }
        \sdocarg{double s}{
    ...
    \begin{sdocfun}
    {
        ...
        \sdocarg{int32\tus{t} lb}{
            Orbital angular momentum quantum number $l=0,2,\dots,n-1$ of bra.
        }
        \sdocarg{double sb}{
        ...
        \sdocarg{int32\tus{t} lk}{
            Orbital angular momentum quantum number $l=0,2,\dots,n-1$ of ket.
        }
        \sdocarg{double sk}{
    ...
    \begin{sdocfun}
    {
        ...
        \sdocarg{int32\tus{t} li}{
            Orbital angular momentum quantum number $l=0,2,\dots,n-1$ of the
